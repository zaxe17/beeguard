...
export const BeefarmNearby = ({
	...
	return (
		<div
			className="p-1.5 flex flex-col rounded-2xl hover:bg-[#fff1ad]/60 transition-all duration-130 ease-in hover:scale-102"
			style={{
				boxShadow:
...
export const BeefarmOperation = ({
	...
	return (
		<div
			className="p-2 flex flex-col rounded-2xl transition-all duration-130 ease-in hover:bg-[#fff1ad]/60 hover:scale-102 hover:shadow-[0px_2px_5px_-1px_rgba(50,50,93,0.25),0px_1px_3px_-1px_rgba(0,0,0,0.3)]">
			<div className="w-full flex gap-3 cursor-pointer">
				{/* BEEFARM PICTURE */}
				<div className="bg-red-600 border border-amber-100 w-20 aspect-square rounded-lg overflow-hidden shrink-0 self-start">
					<Image
